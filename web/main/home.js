export const Obj = {
	...
	content : [
		...
		`<p>Until now there are only 3 modules available<p/>
		<ul class='module_list'>
			<li><a href="/VigyMat/modules/Misc/test.js">Test</a></li>
			<li><a href="/VigyMat/modules/Misc/cube.js">Cube</a></li>
			<li><a href="/VigyMat/modules/Misc/sphere.js">Sphere</a></li>
		</ul>`
	]
};
